...
{
    public class RabbitMQAirline : BackgroundService
    {
        ...
        public RabbitMQAirline(IMapper mapper, IServiceScopeFactory serviceScopeFactory)
        {
            //_db = db;
            _mapper = mapper;
        ...
        public async Task<bool> AddOrder(AirlineViewDto airlinedto)
        {
            using (var scope = _serviceScopeFactory.CreateScope())
            {
                var dbContext = scope.ServiceProvider.GetRequiredService<ScheduleDbContext>();
                Airline airdto = _mapper.Map<AirlineViewDto, Airline>(airlinedto);
